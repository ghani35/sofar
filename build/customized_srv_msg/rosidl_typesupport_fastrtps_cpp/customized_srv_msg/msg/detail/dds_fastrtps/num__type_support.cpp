...
#include "customized_srv_msg/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const customized_srv_msg::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<customized_srv_msg::msg::Num *>(
    untyped_ros_message);
...
{
  return &customized_srv_msg::msg::typesupport_fastrtps_cpp::_Num__handle;
}
